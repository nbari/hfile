...
- Added regression coverage for checksum verification with `hfile`-generated manifests, GNU-style manifests, and mismatched digests.
...
- Refined the GitHub Actions workflows after `0.4.0`, including the deploy job dependency fix and the Linux/macOS test matrix.
